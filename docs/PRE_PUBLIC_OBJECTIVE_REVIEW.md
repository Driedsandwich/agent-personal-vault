...
| GitHub repository settings | needs-action-before-public | repository descriptionが空、Wikiが有効。public化直前にdescription設定とWiki無効化を推奨 |
...
7. GitHub repository descriptionが空。public化前に短い説明文を設定する方がよい。
8. GitHub Wikiが有効。public化前に無効化するか、少なくとも編集権限を確認する方がよい。
...
GitHub repository visibilityをpublicへ変更する判断は可能。ただし、直前にrepository description設定とWiki無効化を行うのが望ましい。
