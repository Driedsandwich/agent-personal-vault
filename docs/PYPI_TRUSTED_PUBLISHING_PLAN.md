...
Use PyPI Trusted Publishing as the normal package publish path after successful `v0.1.5`, `v0.1.6`, and `v0.1.7` OIDC publishes.
...
- Trusted Publishing has been used successfully for `v0.1.5`, `v0.1.6`, and `v0.1.7`.
...
The workflow file exists and OIDC publishes succeeded for `v0.1.5`, `v0.1.6`, and `v0.1.7`. Do not run it for another real publish until the next version, tag, release, package availability, artifact, CI, security, and human approval gates are complete.
